...
object ScanningService {
    ...
    //    Regex to match against dates (12-11, 19.dec, 24:08, 22-apr)
    private val noYearRegex = Regex("(:?(0[1-9]{1}|1[0-9]{1}|2[0-9]{1}|3[0-1]))(:?(\\/|-|:|.| ))(:?((0[1-9]{1}|1[0-2]{1})|jan|feb|mar|apr|may|jun|jul|aug|oct|nov|dec|okt|mei|mrt{3}))")
    /**
        ...
        val detector = FirebaseVision.getInstance() .onDeviceTextRecognizer
                ...
                detector.processImage(image)
                    .addOnSuccessListener { firebaseVisionText ->
                        ...
                        if (matchedText == null) {
                            matchedText = noYearRegex.find(firebaseVisionText.text.toLowerCase(), 0)
                        }
