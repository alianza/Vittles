            ...
            if (dX < 0) {
                ...
                if (dX > -viewHolder.itemView.width / 3) {
                    drawIcon(
                        c,
                        viewHolder,
                        context.getDrawable(R.drawable.ic_delete_1)!!,
                        IconLocation.RIGHT
                    )
                    ...
                    drawIcon(
                        c,
                        viewHolder,
                        context.getDrawable(R.drawable.ic_delete_2)!!,
                        IconLocation.RIGHT
                    )
                    ...
                    drawIcon(
                        c,
                        viewHolder,
                        context.getDrawable(R.drawable.ic_delete_3)!!,
                        IconLocation.RIGHT
                    )
                }
            } else {
                ...
                if (dX < viewHolder.itemView.width / 3) {
                    drawIcon(
                        c,
                        viewHolder,
                        context.getDrawable(R.drawable.ic_eaten_1)!!,
                        IconLocation.LEFT
                    )
                } else if (dX > viewHolder.itemView.width / 3 && dX < viewHolder.itemView.width / 2) {
                    drawIcon(
                        c,
                        viewHolder,
                        context.getDrawable(R.drawable.ic_eaten_2)!!,
                        IconLocation.LEFT
                    )
                } else if (dX > viewHolder.itemView.width / 2) {
                    drawIcon(
                        c,
                        viewHolder,
                        context.getDrawable(R.drawable.ic_eaten_3)!!,
                        IconLocation.LEFT
                    )
                }
            }
        ...
        private fun showSwipeLines(
            ...
            if (viewHolder.layoutPosition != 0) {
                val viewHolderAbove =
                    recyclerView.findViewHolderForLayoutPosition(viewHolder.layoutPosition - 1)
                viewHolderAbove?.let {
                    it.itemView.borderDecorator.visibility = View.INVISIBLE
                }
            }
